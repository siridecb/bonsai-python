...
_SIMULATIONSOURCEDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='selection', full_name='bonsai.proto.generator_simulator_api.SimulationSourceData.selection', index=4,
